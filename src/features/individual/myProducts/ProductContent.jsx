...
const ProductContent = ({ search, category, status }) => {
    ...
    let empty = (
        <div className="w-full max-w-full mx-auto col-span-full mt-5">            <div className="relative overflow-hidden rounded-2xl border border-zinc-800 bg-[#0B121D] px-6 py-16 text-center">
