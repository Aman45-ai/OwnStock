            ...
            <div>
                {products.length == 0 ? empty :
                    products.slice(-2).toReversed().map((value) => (
                        <div key={value.id} className="flex flex-wrap lg:flex-nowrap items-center gap-4 py-3 border-b border-zinc-800 last:border-b-0">                        <div className="w-16 h-16 shrink-0 bg-zinc-800 rounded-lg overflow-hidden">
